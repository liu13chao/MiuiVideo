...
public class ScoringView extends LinearLayout implements View.OnClickListener{
	...
	private int scoringViewWidth;
	private int scoringViewHeight;
	...
	private void initDimen() {
		context = getContext();
		scoringViewWidth = context.getResources().getDimensionPixelSize(R.dimen.scoring_view_width);
		scoringViewHeight = context.getResources().getDimensionPixelSize(R.dimen.scoring_view_height);
	}
	...
	private void initUI() {
		...
		LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
				scoringViewWidth, scoringViewHeight);
