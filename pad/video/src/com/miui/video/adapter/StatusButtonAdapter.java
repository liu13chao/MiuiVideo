...
public class StatusButtonAdapter extends BaseAdapter implements
	...
	public int getCount() {
		...
		return (int) Math.ceil(mStatusBtnItemList.size() / (float) 5);
	}
	...
	private void initViewHolder(ViewHolder vHolder, View convertView) {
		vHolder.vEpisode = new StatusBtn[5];
		...
		vHolder.vEpisode[3] = (StatusBtn) convertView.findViewById(R.id.episode4);
		vHolder.vEpisode[4] = (StatusBtn) convertView.findViewById(R.id.episode5);
