...
public class VpCtrlMenuItem extends FrameLayout {
	...
	public VpCtrlMenuItem(Context context) {
		super(context);
	...
	private void initDimen() {
		...
		mMenuItemHeight = getResources().getDimensionPixelSize(R.dimen.vp_common_ctrl_item_height);
