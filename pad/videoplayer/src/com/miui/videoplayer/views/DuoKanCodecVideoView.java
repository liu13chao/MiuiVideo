...
public class DuoKanCodecVideoView  extends DuoKanCodecOriginVideoView implements ITempVideoView{
	private DuoKanMediaController mDuoKanMediaController;
	private Context mContext;
	
	public DuoKanCodecVideoView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		this.mContext = context;
	}

	public DuoKanCodecVideoView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
	}

	public DuoKanCodecVideoView(Context context) {
		super(context);
		this.mContext = context;
	}
