...
public abstract class AbstractVerticalSeekbarPopupWindows extends ManagedPopupWindow {
	...
	private void setupWindows() {
		...
		if (DuoKanConstants.ENABLE_V5_UI) {
			mSeekbarLength = (int) mContext.getResources().getDimension(R.dimen.popup_vertical_seekbar_length_v5);
			mVerticalSpace = (int) mContext.getResources().getDimension(R.dimen.popup_vertical_seekbar_vertical_space_v5);
			mSeekbarPadding = (int) mContext.getResources().getDimension(R.dimen.popup_vertical_seekbar_padding_v5);
		} else {
...
//	            	updateProgressTextView(progress);
		...
		mImageWidth = bitmapDrawable.getBitmap().getWidth();
