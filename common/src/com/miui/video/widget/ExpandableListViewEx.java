 ...
 *
 */
public class ExpandableListViewEx extends ExpandableListView implements OnScrollListener {
	...
	private boolean mLoadingMoreCurPhaseFinished = true;
	...
	public void setCanLoadMore(boolean canLoadMore) {
		...
		this.mLoadingMoreCurPhaseFinished = true;
	}
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (mCanLoadMore && mLoadingMoreCurPhaseFinished) {
			if (isLoadMoreViewShown()) {
				if(mOnLoadMoreListener != null) {
					mOnLoadMoreListener.onLoadMore(this);
					mLoadingMoreCurPhaseFinished = false;
				}
			}
		}
