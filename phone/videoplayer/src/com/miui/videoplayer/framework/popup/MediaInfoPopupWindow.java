...
//	private View mAnchor;
	...
	private MediaInfoPopupWindow(Context context) {
		super(LayoutInflater.from(context).inflate(R.layout.vp_popup_video_info, null), LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
...
//		mAnchor = anchor;
		int x = (int) mContext.getResources().getDimension(R.dimen.popup_media_info_location_x);
		int y = (int) mContext.getResources().getDimension(R.dimen.popup_media_info_location_y);
