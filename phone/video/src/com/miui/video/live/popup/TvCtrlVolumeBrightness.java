...
public class TvCtrlVolumeBrightness {
	...
	private void showBrightnessPopupWindow() {
		if (mBrightnessPopupWindow == null) {
			...
			if (DuoKanConstants.ENABLE_V5_UI) {
				mBrightnessPopupWindow = new BrightnessPopupWindow(mActivity, R.layout.vp_popup_left_vertical_seebar_group);
			}
		}
	...
	private void showVolumePopupWindow() {
		if (mVolumePopupWindow == null) {
			...
			if (DuoKanConstants.ENABLE_V5_UI) {
				mVolumePopupWindow = new VolumePopupWindow(mActivity, R.layout.vp_popup_right_vertical_seekbar_group);
			}
		}
