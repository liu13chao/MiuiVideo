...
public class CommentReviewListAdapter extends BaseGroupAdapter<MediaReview> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(size == 1) {
			convertView.setBackgroundResource(R.drawable.com_item_bg_full_n);
		} else {
			if(position == 0) {
				convertView.setBackgroundResource(R.drawable.com_item_bg_up_n);
