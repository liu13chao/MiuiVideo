...
public class StatusBtnLong extends RelativeLayout{
	...
	private void initDimen() {
		...
		mTextSize = res.getDimensionPixelSize(R.dimen.font_size_38);
		mTextColor = res.getColor(R.color.p_80_white);
		mTextColorDisable = res.getColor(R.color.p_50_white);
		...
		mDividerHeight = res.getDimensionPixelSize(R.dimen.video_common_divider_height);
	}
	...
	private void initUI() {
		...
		mLeftTvFocus.setEllipsize(TruncateAt.END);
		...
		mDividerView.setBackgroundResource(R.drawable.com_10_black);
	...
	private void refreshPercent() {
		if(mStatusBtnItem != null) {
			int percent = (int) (mStatusBtnItem.percent * 100);
