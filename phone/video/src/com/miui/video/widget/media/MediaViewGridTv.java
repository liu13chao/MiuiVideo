...
import com.miui.video.adapter.MediaViewGridTvAdapter;
 ...
 *
 */
public class MediaViewGridTv extends MediaViewGrid {

	private Context mContext;
	private GridView mGridView;
	private MediaViewGridTvAdapter mAdapter;
	
	private int NUM_COLUMNS = 3;
	
	public MediaViewGridTv(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		init();
	}

	public MediaViewGridTv(Context context) {
		super(context);
		mContext = context;
		init();
	}
	...
	private void init() {
		...
		mAdapter = new MediaViewGridTvAdapter(mContext);
