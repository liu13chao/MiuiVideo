...
public class RatingView extends LinearLayout {
	...
	private void init() {
		...
		for (int i = 0; i < STAR_COUNT; i++) {
			...
			image.setPadding(mStarViewPadding, mStarViewPadding, mStarViewPadding, mStarViewPadding);
	...
	private void initDimen() {
		mStarViewPadding = context.getResources().getDimensionPixelSize(R.dimen.rating_view_padding);
	}
