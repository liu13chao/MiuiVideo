...
public class AddonHandler {
	...
	private void showInstallDialog() {
		...
		String negativeStr = mActivity.getResources().getString(R.string.cancel);
		String positiveStr = mActivity.getResources().getString(R.string.install_comfirm);
		
		mAlertDialog = new AlertDialog.Builder(mActivity, miui.R.style.Theme_Light_Dialog_Alert).create();
		mAlertDialog.setCancelable(false);
        mAlertDialog.setTitle(mAddonInfo.getName());       
        mAlertDialog.setMessage(mAddonInfo.getDescription());
        mAlertDialog.setButton(AlertDialog.BUTTON_POSITIVE, positiveStr, new DialogInterface.OnClickListener(){
			@Override
        ...
        mAlertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, negativeStr, new DialogInterface.OnClickListener(){
			@Override
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
			}
	...
	private void showLoadingDialog() {
		...
		String negativeStr = res.getString(R.string.cancel);
	...
	private void showCompleteDialog() {
		...
		String negativeStr = res.getString(R.string.cancel);
		String positiveStr = res.getString(R.string.start_addon);
		
		mAlertDialog = new AlertDialog.Builder(mActivity, miui.R.style.Theme_Light_Dialog_Alert).create();
		mAlertDialog.setCancelable(false);
        mAlertDialog.setTitle(mAddonInfo.getName());
        mAlertDialog.setMessage(disc);
        mAlertDialog.setButton(AlertDialog.BUTTON_POSITIVE, positiveStr, new DialogInterface.OnClickListener(){
			@Override
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
	...
	private void showErrorDialog(int nError) {
		...
		String negativeStr = res.getString(R.string.cancel);
		String positiveStr = res.getString(R.string.retry);
	...
	private void showUpdateDialog() {
		...
		String negativeStr = res.getString(R.string.cancel);
		String positiveStr = res.getString(R.string.upgrade);
