...
public class ChannelFilterSupply implements Observer {
	...
	private void onFilterMediasDone(boolean isError) {
		for(int i = 0; i < listeners.size(); i++) {
			...
			if(listener != null) {
				listener.onFilterMediasDone(new ArrayList<MediaInfo>(filterMedias), isError, canLoadMore);
			}
		}
	}
	...
	public interface ChannelFilterListener {
		public void onFilterMediasDone(List<MediaInfo> filterMedias, boolean isError, boolean canLoadMore);
	}
}
